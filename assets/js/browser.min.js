...
let person = prompt("Please enter your name", "Forrest Gump");

if (person == null || person === "") {
  window.alert("User cancelled the prompt.");
} else {
  // Ask how they are feeling with multiple options
  let mood = prompt("How are you feeling today?");

  // Check the user's response and show a message accordingly
  if (mood === "Great" || mood === "great") {
    window.alert("Hello " + person + "! It's great to hear you're feeling great!");
  } else if (mood === "Fantastic" || mood === "fantastic") {
    window.alert("Hello " + person + "! It's fantastic to hear you're feeling fantastic!");
  } else if (mood === "Good" || mood === "good") {
    window.alert("That's good to hear, " + person + "! Keep up the positive vibes!");
  } else if (mood === "Ok" || mood === "ok") {
    window.alert("Thanks for sharing, " + person + ". Hope your day improves!");
  } else if (mood === "Bad" || mood === "bad") {
    window.alert("I'm sorry to hear that, " + person + ". I hope things get better soon.");
  } else if (mood === "Tired" || mood === "tired") {
    window.alert("Get some sleep or eat something healthy, " + person + ". That will maybe help :)");
  } else {
    window.alert("Hello " + person + "! I hope you have a wonderful day, no matter how you're feeling!");
  }
}
